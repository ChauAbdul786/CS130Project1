...
{
    vec3 normal;
    normal = (point - center).normalized(); //Because both the point and center are vec3,
                                            //subtracting the two will result in a vector pointing in 
                                            //the right direction. From there we just have to normalize.
    return normal;
}
